  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login" screenOptions={{
        ...
        <Stack.Screen name="detail" component={RestaurantScreen} options={{ title: 'Detail Screen' }} />
        <Stack.Screen name="camera" component={Camera} options={{ title: 'Camera Screen' }} />
        ...
        <Stack.Screen name="Restaurant detail" component={RestaurantDetail} options={{ title: 'Restaurant detail Screen' }} />
