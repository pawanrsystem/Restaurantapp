    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{
          ...
          <Image source={require("../assets/crokery.png")} style={{ height: 127, width: 128 }} />
          <Text style={styles.title}>rate my Dine</Text>
          <Text style={{ fontSize: 20, color: "#2E3A59", fontSize: 20 }}>Where you find best reataurants.</Text>
          <View style={styles.forgot_button}>
            <Text style={{ textAlign: 'center', color: '#807C7C', fontSize: 14 }}>Submit the 4 digit code you got on your provided number.</Text>
          </View>
          <OTPInputView
          ...
          />
          <TouchableOpacity style={styles.loginBtn} onPress={this._otpClick.bind(this)}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Text style={{ color: '#fff', fontSize: 20 }}>Verify your OTP </Text>
              <Image source={require("../assets/next.png")} />
            </View>
          </TouchableOpacity>
          <Text style={{ textAlign: 'center', textDecorationLine: 'underline', color: '#807C7C' }}>Don't recieve on OTP?Resend</Text>
        </View>
      </View>
